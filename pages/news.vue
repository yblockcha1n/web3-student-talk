<template>
        ...
        <div class="container mx-auto px-4">
          <div class="max-w-5xl mx-auto">
            ...
            <div class="grid md:grid-cols-2 gap-6 mb-10">
              <BaseCard v-for="(news, index) in paginatedNews" :key="index" className="h-full">
  ...
  import { getCategoryClass, getCategoryName, calculatePaginationRange } from '~/utils/helpers'
